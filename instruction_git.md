...
Ветки в git нужны например для черновиков, которые нужны потом отредактированными перенесем в текущую мастер-ветку. Если над проектом работают много людей, каждый делает свой участок работы на отдельной ветке. Затем ответственный за проект человек сливает ветки в ветку-мастер и редактирует окончательный вариант.   
...
Не забыть сохранить (закомитить) окончательный вариант перейти.  
